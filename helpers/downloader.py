...
class Downloader:
        ...
        for county in self.urls_to_download:
            ...
            for download_url in self.urls_to_download[county]:
                ...
                logger.debug('Downloading file from %s to %s',
                             download_url, file_download_path)
    ...
    def remove_unneeded_files(self: 'Downloader', county: str,
                              county_data_path: os.path) -> None:
        """
        ...
        Args:
            ...
            county (str): The name of the county whose data files should
            be processed.
            county_data_path (os.PathLike): The path to the directory
            containing the county's data files.
